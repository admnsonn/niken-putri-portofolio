...
import { GraduationCap, Laptop, Languages, Heart, Award, CheckSquare, ShieldCheck, Sparkles } from "lucide-react";
...
export default function Skills() {
  ...
  return (
    <section id="kompetensi" className="py-20 bg-brand-50 relative border-t border-b border-brand-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-brand-950 mt-4 tracking-tight" id="skills-heading">
          ...
          {skillCategories.map((cat, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className={`p-2.5 rounded-xl border ${getCategoryColor(cat.iconName)}`}>
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-gradient-to-r from-brand-900 to-brand-950 text-white rounded-3xl p-6 sm:p-8 shadow-lg relative overflow-hidden"
        >
          {/* Decorative subtle background overlay */}
          <div className="absolute right-0 bottom-0 w-64 h-64 bg-brand-800/20 rounded-full filter blur-2xl" />
          
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center relative z-10">
            <div className="md:col-span-8 space-y-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-amber-500/20 text-amber-300 text-[10px] font-bold uppercase tracking-widest">
              ...
              <p className="text-xs sm:text-sm text-brand-100 max-w-xl leading-relaxed">
                Diakreditasi secara resmi oleh Badan Nasional Sertifikasi Profesi (BNSP), menandakan kompetensi teknis profesional dan andal dalam operasional perkantoran, manipulasi pengolah data, dan administasi digital sekolah dasar.
              </p>
            </div>
            <div className="md:col-span-4 flex justify-start md:justify-end">
              <div className="p-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 inline-flex items-center gap-3">
                <Award className="w-10 h-10 text-amber-400 shrink-0" />
                <div className="flex flex-col">
                  <span className="text-[9px] font-bold text-amber-300 uppercase leading-none">Penyelenggara</span>
                  <span className="text-sm font-extrabold text-white mt-1">LSP BNSP RI</span>
                </div>
              </div>
            </div>
          </div>
